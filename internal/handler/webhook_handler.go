...
func (h *WebhookHandler) HandleCertificateNotification(c *gin.Context) {
	...
	h.webhookSvc.StoreWebhookRequestLog(
		...
		"CERTIFICATE_PSRE_NOTIFICATION",
		bodyString,
		"processing",
		"received",
	)

	var req dto.WebhookCertificateNotificationRequest
	...
	err = h.webhookSvc.SendCertificateNotification(req)
	if err != nil {
